<?php
    ...
    if(isset($_POST['csearch'])){
        ...
        $i = 0;
        $sql = "SELECT * FROM couriers where source = '$source' and destination='$destination' and travelDate = '$date' and type = '$type' and weight >= '$weight'";
        ...
        if (mysqli_num_rows($result) > 0) {
            while($row = mysqli_fetch_assoc($result)) {
               ...
               $details[$i]['weight'] = $row['weight'];
               $i++;
            }
            $temp = 1;
        } else {
            $message = "No Services found on given data";
        }
    }
?>
<!DOCTYPE html>
                                    ...
                                    <form action="#" method="post" novalidate autocomplete="off" class="idealforms searchtours">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="field">
                                                    <select id="destination" name="type">
                                                        <option value="default">Package Type</option>
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="field">
                                                    <input name="weight" type="text" placeholder="Weight (LB's)">
                                                </div>
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="field buttons">
                                                    <button type="submit" name ="csearch" class="btn btn-lg green-color">Search</button>
                                                </div>
                                    ...
                                    <ul class="ride-meta">
                                        ...
                                        <li class="ride-people">
                                            <a href="#" class="tooltip-link" data-original-title="Number of seats" data-toggle="tooltip">
                                                <?php echo $details[$i]['type'];?>
                                            </a>
                                        </li><!-- end .ride-people -->
                                         <li class="ride-people">
                                            <a href="#" class="tooltip-link" data-original-title="Number of seats" data-toggle="tooltip">
                                                <?php echo $details[$i]['weight']."LB's";?>
                                            </a>
                                        </li><!-- end .ride-people -->
                                    </ul><!-- end .ride-meta -->
