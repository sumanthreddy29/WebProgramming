...
function getNumberOfHoursWorked(){
	while (keepGoing){
		hours=prompt("Enter the number of hours worked in a week for employee " + employeeNumber + " (Enter a negative number to end)");
...
function generateOutputString(){
	...
	outputString += "</table>";
	outputString += "<br><br><p class='total'> <b>Total Pay of all employees: $" + totalWeeklyIncome + "</b></p>";
