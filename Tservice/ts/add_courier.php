<?php 
    ...
    if(isset($_POST['addCourier'])){
        ...
        $query = "INSERT INTO couriers (riderName,emailid,source,destination,travelDate,travelTime,type,weight) VALUES ('$username','$email','$source','$destination','$date','$time','$type','$weight')";
        $data = mysqli_query($conn,$query) or die(mysqli_error($conn));
        if($data){
            $message = 'Courier Details Added';
        }
    }
?>
<!DOCTYPE html>
                        ...
                        <div class="page-content add-new-ride">
                            ...
                            <form action="#" method="post" novalidate autocomplete="off" class="idealforms add-ride">
                                ...
                                <div class="field buttons">
                                    <button type="submit" name="addCourier" class="btn btn-lg green-color">Submit</button>
                                </div>
